...
echo ""
echo "  Run icecat-bin under valgrind with arguments"
echo ""
echo "    ${cmdname} -g -d valgrind -a '--tool=memcheck --leak-check=full' icecat-bin"
echo ""
	return 0
}
##########################################################################
...
## when a user (developer) tries to start icecat, thunderbird, or seamonkey
